...
public class accessToSafeWaterTest {
...
@Test (timeout=30000)
	...
	accessToSafeWater compareIndic =new accessToSafeWater();
	Vector<Double> dataList= accessToSafeWater.performAnalysis(year1, year2, CC);
